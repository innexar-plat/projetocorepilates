...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }): Promise<Metadata> {
  ...
  const description = isEn
    ? 'Talk to Brazilian Core Pilates in Sebastian, Florida. We reply as quickly as possible.'
    : isPt
      ? 'Fale com a Brazilian Core Pilates em Sebastian, Florida. Respondemos o mais rapido possivel.'
      : 'Reserva una clase de prueba gratuita o contáctanos. Respondemos en 24 horas.';
  return {
    title,
    description,
    alternates: {
      canonical: `https://braziliancorepilates.com/${locale}/contato`,
      languages: {
        en: '/en/contato',
        pt: '/pt/contato',
        es: '/es/contato',
    ...
    openGraph: { title, description, url: `https://braziliancorepilates.com/${locale}/contato` },
  };
}
...
const INFO_ITEMS = [
  ...
  },
  {
    ...
    label: 'WhatsApp',
    value: 'Fernanda Santos  (772) 404-9031\nCleide Ostroff  (321) 490-2035',
    href: 'https://wa.me/17724049031',
  },
  {
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    label: 'Email',
    value: 'admin@braziliancorepilates.com\nbraziliancorepilates@gmail.com',
    href: 'mailto:admin@braziliancorepilates.com',
  },
  {
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    label: 'Hours',
    value: 'Grand Opening: Saturday, June 6th, 10:00 AM – 2:00 PM',
  },
];
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.4fr]">
          ...
          <FadeIn variant="left">
            <div className="space-y-8">
              ...
              {/* Instagram CTA */}
              <a
                href="https://instagram.com/braziliancorepilates"
                target="_blank"
