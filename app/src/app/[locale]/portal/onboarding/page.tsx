...
import { PortalOnboardingContent } from '@/components/sections/PortalOnboardingContent';
import { getTranslations } from 'next-intl/server';
import type { Locale } from '@/i18n/routing';

export default async function PortalOnboardingPage({ params }: { params: Promise<{ locale: Locale }> }) {
